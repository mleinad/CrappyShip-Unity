...
public class GBufferPassU2021Feature : ScriptableRendererFeature
{
    ...
    public override void Create()
    {
        ...
        gBufferPass = new GBufferPassU2021(settings);// settings);
    ...
    //{
    //    gBufferPass.Setup(renderer.cameraColorTargetHandle);  // use of target after allocation
    //}
    ...
    public override void AddRenderPasses(ScriptableRenderer renderer, ref RenderingData renderingData)
    {
        ...
        // GBuffer
        {
            if (settings.UseMRT)
            {
                ...
                // gBufferPass.Setup(renderer.cameraColorTargetHandle);// cameraColorTarget);
